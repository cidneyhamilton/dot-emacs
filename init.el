...
(custom-set-variables
 ...
 '(package-selected-packages
	 '(nov lsp-mode elfeed ef-themes dash gdscript-mode eglot yasnippet use-package solarized-theme org-yaap org-drill modus-themes mastodon magit jsonrpc ink-mode hydra graphviz-dot-mode flymake external-completion emms ement elfeed-tube discover dictionary darkroom csharp-mode company babel))
